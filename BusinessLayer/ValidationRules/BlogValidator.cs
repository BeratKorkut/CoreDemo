...
namespace BusinessLayer.ValidationRules
{
    public class BlogValidator : AbstractValidator<Blog>
    {
        public BlogValidator() 
        {
            ...
            RuleFor(x => x.BlogTitle).MinimumLength(6).WithMessage("Lütfen 5 karakterden daha fazla veri girişi yapın.");
            ...
            RuleFor(x => x.BlogContent).MinimumLength(6).WithMessage("Lütfen 5 karakterden daha fazla veri girişi yapın.");
